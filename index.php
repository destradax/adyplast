...
<head>
	...
	<meta name="author" content="adyplast">
...
<body>
			...
			<nav class="navbar navbar-inverse navbar-static-top">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">Adyplast</a>
					</div>
			...
			<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption">
						...
						<p>&nbsp;</p>
						<p><a class="btn btn-lg btn-primary" href="#escribenos" role="button">Escríbenos!</a></p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container marketing">
		...
		<footer>
			...
			<p>&copy; 2015 Adyplast.co | Medellín </p>
		</footer>
